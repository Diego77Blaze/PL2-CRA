...
nombre(n(n_3),f,pl,com,_,terc) --> [tijeras].
nombre(n(n_4),f,sg,com,_,terc) --> [manzana].
nombre(n(n_5),m,sg,com,_,terc) --> [hombre].
nombre(n(n_6),m,_,prop,_,terc) --> [juan].
nombre(n(n_7),f,_,prop,_,terc) --> [maria].
nombre(n(n_8),m,sg,com,_,terc) --> [gato].
nombre(n(n_9),m,sg,com,_,terc) --> [raton].
nombre(n(n_10),f,sg,com,_,terc) --> [universidad].
nombre(n(n_11),m,sg,com,_,terc) --> [alumno].
nombre(n(n_12),m,sg,com,_,terc) --> [perro].
nombre(n(n_13),m,sg,com,_,terc) --> [vecino].
nombre(n(n_14),m,sg,com,_,terc) --> [canario].
nombre(n(n_15),m,sg,com,_,terc) --> [cafe].
